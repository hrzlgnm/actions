# actions-github-cppcheck Docker image
...
following commands:
    ...
    $ docker build --tag ghcr.io/hrzlgnm/actions-github-cppcheck:VERSION_NUMBER_HERE .github/docker/actions-github-cppcheck/
    $ docker login ghcr.io -u YOUR_GITHUB_USER_NAME_HERE
    $ docker push ghcr.io/hrzlgnm/actions-github-cppcheck:VERSION_NUMBER_HERE
