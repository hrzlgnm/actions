...
* add missing checkout step to publish job in release workflow ([#268](https://github.com/hrzlgnm/actions/issues/268)) ([705fc77](https://github.com/hrzlgnm/actions/commit/705fc7731f6ff18906e687d86be74dfa6ea68420))
...
* only approve workflow runs for latest PR head ([#253](https://github.com/hrzlgnm/actions/issues/253)) ([9d9f31d](https://github.com/hrzlgnm/actions/commit/9d9f31db7089d5da1651c71cf088e8a4a156725d))
...
- *(deps)* Update dtolnay/rust-toolchain digest to 6bed076 (#224) ([#224](https://github.com/hrzlgnm/actions/pull/224))

## [2.8.2] - 2026-09-02 [compare](https://github.com/hrzlgnm/actions/compare/v2.8.1...v2.8.2)

### Dependencies

- *(deps)* Update crate-ci/typos action to v1.50.1 (#220) ([#220](https://github.com/hrzlgnm/actions/pull/220))

- *(deps)* Update dependency git-cliff to v2.14.1 (#221) ([#221](https://github.com/hrzlgnm/actions/pull/221))

## [2.8.1] - 2026-08-28 [compare](https://github.com/hrzlgnm/actions/compare/v2.8.0...v2.8.1)

### Dependencies

- *(deps)* Update crate-ci/typos action to v1.50.0 (#218) ([#218](https://github.com/hrzlgnm/actions/pull/218))
